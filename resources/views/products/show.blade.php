        ...
        <div class="bg-white shadow-xl rounded-3xl overflow-hidden">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-0">
                        ...
                        <div class="flex gap-4">
                            ...
                            <div class="flex-1 relative">
                                ...
                                <div class="absolute top-4 right-4 bg-gray-900/80 backdrop-blur-sm px-4 py-2 rounded-lg">
                                    <span class="text-white font-medium text-sm" id="imageCounter">1 / {{ count($product->images) }}</span>
                                </div>
                                @endif
                            </div>
                ...
                <div class="p-8 lg:p-10 flex flex-col bg-gray-50">
                    ...
                    <!-- Title & Price -->
                    <div class="mb-8">
                        <h1 class="text-3xl lg:text-4xl font-bold text-gray-900 mb-6">{{ $product->title }}</h1>
                        <div class="inline-block bg-gradient-to-r from-blue-500 to-blue-600 px-8 py-4 rounded-2xl shadow-lg">
                            <span class="text-3xl font-bold text-white">${{ number_format($product->price) }}</span>
                        </div>
                    </div>
...
function changeImage(imageSrc, index) {
    ...
    document.getElementById('imageCounter').textContent = (index + 1) + ' / {{ count($product->images ?? []) }}';
